...
def pushminiocountry(country):
    ...
    files = [
        ...
        (GRID_PATH / f"{country}/osm_pdm_substations.gpkg",
         f"data-countries/{country}/osm_pdm_substations.gpkg"),
        (GRID_PATH / f"{country}/osm_pdm_linesxnodes.gpkg",
         f"data-countries/{country}/osm_pdm_linesxnodes.gpkg"),
        (GRID_PATH / f"{country}/osm_pdm_lines.gpkg",
         f"data-countries/{country}/osm_pdm_lines.gpkg"),
        (GRID_PATH / f"{country}/osm_pdm_nodes.gpkg",
         f"data-countries/{country}/osm_pdm_nodes.gpkg"),
        (GRID_PATH / f"{country}/osm_clean_power_substation.gpkg",
         f"data-countries/{country}/osm_clean_power_substation.gpkg"),
